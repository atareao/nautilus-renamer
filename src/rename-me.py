...
class RenameDialog(Gtk.Dialog): # needs GTK, Python, Webkit-GTK
	def __init__(self,files = None):
		#***************************************************************
		Gtk.Dialog.__init__(self,'rename-me',None,Gtk.DialogFlags.MODAL | Gtk.DialogFlags.DESTROY_WITH_PARENT,(Gtk.STOCK_OK, Gtk.ResponseType.ACCEPT))
		...
		frame1.add(vbox11)
		#
		vbox11.pack_start(Gtk.Label('{filename} = %s'%_('The name of the file')),False,False,0)
		vbox11.pack_start(Gtk.Label('{extension} = %s'%_('The extension of the file')),False,False,0)
		vbox11.pack_start(Gtk.Label('{iterator} = %s'%_('An iterator')),False,False,0)
		vbox11.pack_start(Gtk.Label('format_number(pattern,number) = %s'%_('A predefinied function to format numbers')),False,False,0)
		#
		frame2 = Gtk.Frame()
		...
		#
		button23 = Gtk.Button()
		button23.set_image(Gtk.Image.new_from_stock(Gtk.STOCK_FIND,Gtk.IconSize.BUTTON))
		...
		button2.set_tooltip_text(_('Rename-me'))
		...
		#
		button24 = Gtk.Button()
		button24.set_image(Gtk.Image.new_from_stock(Gtk.STOCK_SAVE,Gtk.IconSize.BUTTON))
		...
		#
		button25 = Gtk.Button()
		button25.set_image(Gtk.Image.new_from_stock(Gtk.STOCK_DELETE,Gtk.IconSize.BUTTON))
		...
		#
		column = Gtk.TreeViewColumn(_('Modified'),Gtk.CellRendererText(),text=2)
		self.treeview.append_column(column)		
		#
		if files:
			for file in files:
...
class RenameFilesMenuProvider(GObject.GObject, Nautilus.MenuProvider):
	...
	def get_file_items(self, window, sel_items):
		...
		item = Nautilus.MenuItem(name='RenameFilesMenuProvider::Gtk-rename-files',
